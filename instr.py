...
txt_next = 'Почати'
txt_instruction = ("Ця програма дозволить вам за допомогою тесту Руф'є провести діагностику вашого здоров'я.\n"
                    "Проба Руф'є є навантажувальним комплексом, призначеним для оцінки працездатності серця при фізичному навантаженні.\n"
                    "У випробуваного, що знаходиться в положенні лежачі на спині протягом 5 хв, визначають частоту пульсу 15 секунд;\n"
                    ...
                    "Важливо! Якщо в процесі проведення випробування ви відчуєете себе погано (з'явиться запаморочення, шум\n"
...
txt_test2 = 'Виконайте 30 присідань за 45 секунд. Для цього натисніть кнопку "Почати робити прісідання", щоб запустити лічильник присідань.'
